...
!(function (e) {
      ...
      return (
        ...
        (t.prototype.scheduleTask = function (e) {
          ...
          try {
            ...
            throw (e._transitionTo(S, k, b), this._zoneDelegate.handleError(this, t), t);
          }
      ...
      u = (function () {
        function e(e, t, n) {
          ...
          (r || (t && t._hasTaskZS)) &&
            ...
            n.onScheduleTask ||
              ((this._scheduleTaskZS = l), (this._scheduleTaskDlgt = t), (this._scheduleTaskCurrZone = this.zone)),
            n.onInvokeTask ||
  ...
  var y = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
    ...
    b = void 0 !== h.process && '[object process]' === {}.toString.call(h.process) && !y && !(!f || !p.HTMLElement),
    k = {},
    T = function (e) {
      if ((e = e || h.event)) {
        var t = k[e.type];
          ...
          (a.set = function (e) {
            ...
            t || n !== h || (t = h),
              t &&
                ...
                s && s.apply(t, d),
                'function' == typeof e ? ((t[f] = e), t.addEventListener(l, T, !1)) : (t[f] = null));
          }),
          (a.get = function () {
            var e = this;
   ...
   */ Zone.__load_patch('ZoneAwarePromise', function (e, t, n) {
    ...
    function k(e, r, a) {
      ...
      if (null === e[d]) {
        ...
        if (!1 !== r && a instanceof O && a.hasOwnProperty(d) && a.hasOwnProperty(v) && null !== a[d])
          E(a), k(e, a[d], a[v]);
        else if (!1 !== r && 'function' == typeof u)
          try {
            u.call(a, l(m(e, r)), l(m(e, !1)));
          } catch (t) {
            l(function () {
              k(e, !1, t);
            })();
          ...
          if (((e[v] = a), e[g] === g && !0 === r && ((e[d] = e[_]), (e[v] = e[y])), !1 === r && a instanceof Error)) {
            ...
            p && o(a, b, { configurable: !0, enumerable: !1, writable: !0, value: p });
          }
          for (var h = 0; h < f.length; ) w(e, f[h++], f[h++], f[h++], f[h++]);
          if (0 == f.length && 0 == r) {
            e[d] = 0;
            var T = a;
            try {
  ...
  function A(e, t, r) {
      ...
      h = function (t) {
        if ((t = t || e.event)) {
          ...
          if (r)
            ...
            else for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[F]); a++) p(o[a], n, t);
        }
      },
      d = function (t) {
        if ((t = t || e.event)) {
    ...
    function v(t, r) {
      ...
      var Z = p
        ...
        z = Zone[u('UNPATCHED_EVENTS')],
        M = e[u('PASSIVE_EVENTS')],
        F = function (t, n, o, a, i, c) {
          return (
            void 0 === i && (i = !1),
            void 0 === c && (c = !1),
            function () {
              ...
              if (!v || v(t, u, s, arguments)) {
                var h = I && !!M && -1 !== M.indexOf(l),
                  d = P(arguments[2], h);
                if (z)
                  for (var y = 0; y < z.length; y++)
                    if (l === z[y]) return h ? t.call(s, l, u, d) : t.apply(this, arguments);
                ...
                return (
                  ...
                  F && (F.taskData = null),
                  b && (d.once = !0),
                  (I || 'boolean' != typeof A.options) && (A.options = d),
                  (A.target = s),
                  (A.capture = m),
                  (A.eventName = l),
                  f && (A.originalDelegate = u),
              ...
              for (var f = 0; f < u.length; f++) {
                ...
                if (j(p, i)) {
                  if (
                    (u.splice(f, 1),
                    (p.isRemoved = !0),
                    0 === u.length && ((p.allRemoved = !0), (t[s] = null), 'string' == typeof n))
                  ) {
            ...
            if (o) {
              ...
              if (l) {
                ...
                for (d = 0; d < f.length; d++)
                  this[a].call(this, n, (p = f[d]).originalDelegate ? p.originalDelegate : p.callback, p.options);
              }
              if (u)
      ...
      if (m) {
        var a = window,
          i = (function c() {
            ...
            : [];
        ce(a, ae.concat(['messageerror']), o ? o.concat(i) : o, n(a)),
          ce(Document.prototype, ae, o),
          void 0 !== a.SVGElement && ce(a.SVGElement.prototype, ae, o),
          ce(Element.prototype, ae, o),
          ce(HTMLElement.prototype, ae, o),
          ce(HTMLMediaElement.prototype, K, o),
          ce(HTMLFrameSetElement.prototype, J.concat($), o),
          ce(HTMLBodyElement.prototype, J.concat($), o),
          ce(HTMLFrameElement.prototype, Q, o),
          ce(HTMLIFrameElement.prototype, Q, o);
        var s = a.HTMLMarqueeElement;
        s && ce(s.prototype, ee, o);
        var l = a.Worker;
        l && ce(l.prototype, oe, o);
      }
      var u = t.XMLHttpRequest;
      u && ce(u.prototype, te, o);
      var f = t.XMLHttpRequestEventTarget;
      f && ce(f && f.prototype, te, o),
        'undefined' != typeof IDBIndex &&
          (ce(IDBIndex.prototype, ne, o),
          ce(IDBRequest.prototype, ne, o),
          ce(IDBOpenDBRequest.prototype, ne, o),
          ce(IDBDatabase.prototype, ne, o),
          ce(IDBTransaction.prototype, ne, o),
          ce(IDBCursor.prototype, ne, o)),
        r && ce(WebSocket.prototype, re, o);
    }
  }
  /**
   * @license
   ...
   */ function le() {
    (q = Zone.__symbol__),
      (U = Object[q('defineProperty')] = Object.defineProperty),
      (V = Object[q('getOwnPropertyDescriptor')] = Object.getOwnPropertyDescriptor),
      (X = Object.create),
      (Y = q('unconfigurables')),
      (Object.defineProperty = function (e, t, n) {
        if (fe(e, t)) throw new TypeError("Cannot assign to read only property '" + t + "' of " + e);
        var r = n.configurable;
        return 'prototype' !== t && (n = pe(e, t, n)), he(e, t, n, r);
      }),
      ...
      (Object.getOwnPropertyDescriptor = function (e, t) {
        var n = V(e, t);
        return n && fe(e, t) && (n.configurable = !1), n;
      });
  }
  function ue(e, t, n) {
    var r = n.configurable;
    return he(e, t, (n = pe(e, t, n)), r);
  }
  function fe(e, t) {
    return e && e[Y] && e[Y][t];
  }
  function pe(e, t, n) {
    return (
      ...
      n.configurable || (e[Y] || Object.isFrozen(e) || U(e, Y, { writable: !0, value: {} }), e[Y] && (e[Y][t] = !0)),
      n
    );
  }
  function he(e, t, n, r) {
        ...
        (n.args[0] = function r() {
          try {
            ...
            (t.data && t.data.isPeriodic) ||
              ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[ge] = null));
          }
        }),
    ...
    (o = P(e, (t += r), function (n) {
      return function (o, a) {
        if ('function' == typeof a[0]) {
          var u = l(
            t,
            a[0],
            { isPeriodic: 'Interval' === r, delay: 'Timeout' === r || 'Interval' === r ? a[1] || 0 : void 0, args: a },
            c,
            s,
          );
          if (!u) return u;
          ...
          return (
            'number' == typeof f ? (i[f] = u) : f && (f[ge] = u),
            f &&
              f.ref &&
              f.unref &&
      ...
      (a = P(e, n, function (t) {
        return function (n, r) {
          var o,
            a = r[0];
          'number' == typeof a ? (o = i[a]) : (o = a && a[ge]) || (o = a),
            o && 'string' == typeof o.type
              ? 'notScheduled' !== o.state &&
                ((o.cancelFn && o.data.isPeriodic) || 0 === o.runCount) &&
                ('number' == typeof a ? delete i[a] : a && (a[ge] = null), o.zone.cancelTask(o))
              : t.apply(e, r);
        };
      }));
  }
      ...
      !(function n(e) {
        ...
        if (n) {
          ...
          var _ = P(h, 'open', function () {
              return function (e, t) {
                return (e[o] = 0 == t[2]), (e[f] = t[1]), _.apply(e, t);
              };
            }),
            ...
            k = P(h, 'send', function () {
              return function (e, n) {
                ...
                if (e[o]) return k.apply(e, n);
                var r = { target: e, url: e[f], isPeriodic: !1, args: n, aborted: !1 },
                  a = l('XMLHttpRequest.send', w, r, E, S);
                e && !0 === e[p] && !r.aborted && 'scheduled' === a.state && a.invoke();
              };
            }),
            T = P(h, 'abort', function () {
              return function (e, n) {
                ...
                if (o && 'string' == typeof o.type) {
                  ...
                  o.zone.cancelTask(o);
                } else if (!0 === t.current[m]) return T.apply(e, n);
              };
            });
        }
        function E(e) {
          ...
          (o[s] = !1), (o[p] = !1);
          var l = o[c];
          d || ((d = o[a]), (v = o[i])), l && v.call(o, 'readystatechange', l);
          var u = (o[c] = function () {
            if (o.readyState === o.DONE)
              if (!n.aborted && o[s] && 'scheduled' === e.state) {
              ...
              } else n.aborted || !1 !== o[s] || (o[p] = !0);
          });
          return d.call(o, 'readystatechange', u), o[r] || (o[r] = e), k.apply(o, n.args), (o[s] = !0), e;
        }
        function w() {}
        function S(e) {
          var t = e.data;
            ...
            var o = t.constructor.name,
              a = function (n) {
                ...
                if (i) {
                  ...
                  t[a] = (function (e) {
                    var t = function () {
                      return e.apply(this, v(arguments, o + '.' + a));
                    };
                    return D(t, e), t;
                  })(i);
                }
