...
!(function () {
  ...
  if (M) {
    ...
    E || console.warn('Invalid '.concat(b, ' meta element - content required.'));
    var N = function (e) {
      return new RegExp(
        (function (e) {
  ...
  })() || (console.warn('Disabling import-map-overrides, since local storage is not readable'), (y = !0)),
    y ||
      (function () {
        var e,
        ...
        window.importMapOverrides = {
          addOverride: function (e, n) {
            ...
            return (
              localStorage.setItem(o, n), t && (document.cookie = ''.concat(o, '=').concat(n)), i(), r.getOverrideMap()
            );
          },
          getOverrideMap: function () {
            for (
              ...
              0 === l.indexOf('import-map-override:') &&
                o(l.slice('import-map-override:'.length), localStorage.getItem(l));
            }
            var a = _('imo', window.parent ? window.parent.location.href : window.location.href);
            if (a) {
              var u;
              try {
                u = JSON.parse(a);
          ...
          removeOverride: function (e) {
            ...
            return (
              ...
              t && (document.cookie = ''.concat(n, '=; expires=Thu, 01 Jan 1970 00:00:01 GMT;')),
              r.enableOverride(e),
              i(),
              o
            );
          ...
          enableUI: function () {
            ...
            e ||
              ((e = document.createElement('import-map-overrides-full')).setAttribute(
          ...
          getDefaultMap: function () {
            return (
              ...
              (e = Array.prototype.reduce.call(
                document.querySelectorAll('script[type="'.concat(O, '"], script[type="overridable-importmap"]')),
                function (e, t) {
                  return t.hasAttribute('data-is-importmap-override')
                    ? e
                    : ((n = t.src ? m(t.src) : Promise.resolve(JSON.parse(t.textContent))),
          ...
          getCurrentPageMap: function () {
            return Promise.all([r.getDefaultMap(), r.getExternalOverrideMap(r.getCurrentPageExternalOverrides())]).then(
              function (e) {
                var t = f(e, 2),
                  n = t[0],
                  o = t[1];
          ...
          getCurrentPageExternalOverrides: function () {
            ...
            return (
              document
                .querySelectorAll('['.concat('data-is-importmap-override', ']:not([id="import-map-overrides"])'))
                .forEach(function (t) {
                  e.push(t.src);
                }),
              e
          ...
          getNextPageMap: function () {
            return Promise.all([r.getDefaultMap(), r.getExternalOverrideMap()]).then(function (e) {
              var t = f(e, 2),
                n = t[0],
                o = t[1];
          ...
          disableOverride: function (e) {
            ...
            return (
              !g(t, e) && (localStorage.setItem('import-map-overrides-disabled', JSON.stringify(t.concat(e))), i(), !0)
            );
          },
          enableOverride: function (e) {
            ...
            return (
              n >= 0 &&
              (t.splice(n, 1), localStorage.setItem('import-map-overrides-disabled', JSON.stringify(t)), i(), !0)
            );
          },
          ...
          addExternalOverride: function (e) {
            ...
            return (
              !g(t, e) &&
              (localStorage.setItem('import-map-overrides-external-maps', JSON.stringify(t.concat(e))), i(), !0)
            );
          },
          ...
          getExternalOverrideMap: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r.getExternalOverrides();
        ...
        function i() {
          setTimeout(function () {
            o && window.dispatchEvent(new CustomEvent('import-map-overrides:change'));
          });
        }
        var l,
          a = r.getOverrideMap(),
        ...
        if (!n) {
          ...
          } else v(), Object.keys(a.imports).length > 0 && (l = c(a, 'import-map-overrides', l));
        }
        function c(e, t, n) {
        ...
        function m(e) {
          return fetch(e).then(
              ...
              return e.ok
                ? e.json().catch(function (t) {
                    return (
                      console.warn(
                        Error(
                          'External override import map contained invalid json, at url '.concat(e.url, '. ').concat(t),
                        ),
                      ),
            ...
            function () {
              return (
                console.warn(Error("Unable to download external import map at url '".concat(e, "'"))),
  ...
  function T(e, t, n) {
    ...
    if (arguments.length > 3) for (n = [n], i = 3; i < arguments.length; i++) n.push(l[i]);
  ...
  function $(e) {
    ((!e.__d && (e.__d = !0) && C.push(e) && !V.__r++) || I !== S.debounceRendering) &&
  ...
  function B(e, t, n, r, o, i, l, a, u, s) {
    var d,
      ...
      g = (r && r.__k) || A,
      _ = g.length;
    for (u == D && (u = null != l ? l[0] : _ ? q(r, 0) : null), n.__k = [], d = 0; d < t.length; d++)
      if (
        null !=
        (m = n.__k[d] =
        ...
        if (((m.__ = n), (m.__b = n.__b + 1), null === (c = g[d]) || (c && m.key == c.key && m.type === c.type)))
          g[d] = void 0;
        else
          for (p = 0; p < _; p++) {
        ...
        (f = Z(e, m, (c = c || D), o, i, l, a, u, s)),
          (p = m.ref) && c.ref != p && (h || (h = []), c.ref && h.push(c.ref, null, m), h.push(p, m.__c || f, m)),
          null != f
            ? (null == v && (v = f),
              (u = H(e, m, c, g, l, f, u)),
              s || 'option' != n.type ? 'function' == typeof n.type && (n.__d = u) : (e.value = ''))
            : u && c.__e == u && u.parentNode != e && (u = q(c));
      }
    if (((n.__e = v), null != l && 'function' != typeof n.type)) for (d = l.length; d--; ) null != l[d] && R(l[d]);
  ...
  function H(e, t, n, r, o, i, l) {
    ...
    if (void 0 !== t.__d) (a = t.__d), (t.__d = void 0);
      ...
      e: if (null == l || l.parentNode !== e) e.appendChild(i), (a = null);
        ...
        for (u = l, s = 0; (u = u.nextSibling) && s < r.length; s += 2) if (u == i) break e;
        e.insertBefore(i, l), (a = l);
      }
    return void 0 !== a ? a : i.nextSibling;
  }
  function G(e, t, n) {
    '-' === t[0] ? e.setProperty(t, n) : (e[t] = null == n ? '' : 'number' != typeof n || j.test(t) ? n : n + 'px');
  }
  ...
  function Z(e, t, n, r, o, i, l, a, u) {
    ...
    null != n.__h && ((u = n.__h), (a = t.__e = n.__e), (t.__h = null), (i = [a])), (s = S.__b) && s(t);
    try {
      e: if ('function' == typeof b) {
        if (
          ...
          n.__c
            ...
            : ('prototype' in b && b.prototype.render
                ? (t.__c = d = new b(h, _))
                : ((t.__c = d = new z(h, _)), (d.constructor = b), (d.render = oe)),
              g && g.sub(d),
              (d.props = h),
              d.state || (d.state = {}),
              (d.context = _),
          ...
          null != b.getDerivedStateFromProps &&
            (d.__s == d.state && (d.__s = L({}, d.__s)), L(d.__s, b.getDerivedStateFromProps(h, d.__s))),
          (c = d.props),
          (m = d.state),
          p)
        )
          null == b.getDerivedStateFromProps && null != d.componentWillMount && d.componentWillMount(),
          ...
          if (
            ...
            (!d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(h, d.__s, _)) ||
              t.__v === n.__v)
          ) {
            (d.props = h),
              (d.state = d.__s),
        ...
        (d.context = _),
          ...
          p || null == d.getSnapshotBeforeUpdate || (f = d.getSnapshotBeforeUpdate(c, m)),
          (y = null != s && s.type == W && null == s.key ? s.props.children : s),
        ...
        null == i && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = te(n.__e, t, n, r, o, i, l, u));
      (s = S.diffed) && s(t);
    } catch (e) {
      (t.__v = null), (u || null != i) && ((t.__e = a), (t.__h = !!u), (i[i.indexOf(a)] = null)), S.__e(e, t, n);
    }
    return t.__e;
  }
  function ee(e, t) {
  ...
  function te(e, t, n, r, o, i, l, a) {
    ...
    if (null === t.type) m === f || (a && e.data === f) || (e.data = f);
      ...
      if (
        ...
        (p || d) &&
          ((p && ((d && p.__html == d.__html) || p.__html === e.innerHTML)) || (e.innerHTML = (p && p.__html) || ''));
      }
      (function (e, t, n, r, o) {
        var i;
        ...
        p
          ? (t.__k = [])
          : ((u = t.props.children),
            B(e, Array.isArray(u) ? u : [u], t, n, r, 'foreignObject' !== t.type && o, i, l, D, a)),
        a ||
          ('value' in f &&
            void 0 !== (u = f.value) &&
            (u !== e.value || ('progress' === t.type && !u)) &&
            X(e, 'value', u, m.value, !1),
          'checked' in f && void 0 !== (u = f.checked) && u !== e.checked && X(e, 'checked', u, m.checked, !1));
    }
    return e;
  }
  function ne(e, t, n) {
  ...
  function ie(e, t, n) {
    ...
    S.__ && S.__(e, t),
      ...
      Z(
        ...
        n && !r ? [n] : o ? null : t.childNodes.length ? A.slice.call(t.childNodes) : null,
        i,
        n || D,
        r,
      ),
  ...
  var le = (function (e) {
      ...
      function l() {
        ...
        return (
          o(p((e = n.call.apply(n, [this].concat(i)))), 'getInitialOverrideUrl', function () {
            var t = new RegExp('//localhost:([0-9]+)/').exec(e.props.module.overrideUrl);
            return t &&
              e.props.module.overrideUrl === window.importMapOverrides.getUrlFromPort(e.props.module.moduleName, t[1])
              ? t[1]
              : e.props.module.overrideUrl
              ? e.props.module.overrideUrl
              : '';
          }),
          o(p(e), 'state', { overrideUrl: e.getInitialOverrideUrl(), moduleName: '' }),
          o(p(e), 'inputEl', null),
          ...
          o(p(e), 'handleSubmit', function (t) {
            t.preventDefault(),
              e.props.module.moduleName &&
                window.importMapOverrides.isDisabled(e.props.module.moduleName) &&
                window.importMapOverrides.enableOverride(e.props.module.moduleName),
        ...
        r(l, [
          {
            ...
            value: function () {
              this.focusFirstInput(), this.dialogEl.addEventListener('keydown', this.keyDown);
            },
          },
          {
            ...
            value: function (e, t) {
              ...
              this.props.module !== e.module &&
                this.setState({ overrideUrl: this.props.module.overrideUrl || '' }, function () {
                  n.focusFirstInput();
                });
            },
          },
                  ...
                  T(
                    ...
                    T(
                      ...
                      T(
                        'tbody',
                        null,
                        !n.isNew && T('tr', null, T('td', null, 'Default URL:'), T('td', null, n.defaultUrl)),
                        n.isNew &&
                          T(
                            'tr',
                            null,
                            T('td', null, T('span', { id: 'module-name-label' }, 'Module Name:')),
                            T(
                              'td',
                              ...
                              T('input', {
                                ...
                                onInput: function (e) {
                                  return t.setState({ moduleName: e.target.value });
                                },
                        ...
                        T(
                          'tr',
                          null,
                          T('td', null, T('span', { id: 'override-url-label' }, 'Override URL:')),
                          T(
                            'td',
                            { style: { position: 'relative' } },
                            T('input', {
                              ...
                              tabIndex: 2,
                              onInput: function (e) {
                                return t.setState({ overrideUrl: e.target.value });
                              },
                            }),
                            T(
                              'div',
                              { role: 'button', tabIndex: 4, className: 'imo-clear-input', onClick: this.clearInput },
                              T('div', null, 'ⓧ'),
                            ),
                          ),
                        ),
                        ae.test(this.state.overrideUrl) &&
                          T('tr', null, T('td', null, 'Derived url:'), T('td', null, this.getDerivedUrl())),
                      ),
                    ),
                    T(
                      'div',
                      ...
                      T(
                        'button',
                        { type: 'button', tabIndex: 5, onClick: this.props.cancel, style: { marginRight: '16px' } },
                        'Cancel',
                      ),
                          ...
                          'button',
                          {
                            ...
                            onClick: function () {
                              t.props.module.disabled
                                ? window.importMapOverrides.enableOverride(t.props.module.moduleName)
                                : window.importMapOverrides.disableOverride(t.props.module.moduleName),
                                t.props.cancel();
                            },
                            tabIndex: 6,
          ...
          o(p(e), 'handleSubmit', function (t) {
            t.preventDefault(),
              e.props.dialogExternalMap.isNew ||
                window.importMapOverrides.removeExternalOverride(e.props.dialogExternalMap.url),
        ...
        r(l, [
          {
            key: 'componentDidMount',
            value: function () {
              this.inputEl.focus(), this.dialogEl.addEventListener('keydown', this.keyDown);
            },
          },
          {
            key: 'componentWillUnmount',
                ...
                T(
                  ...
                  T(
                    ...
                    T(
                      'h3',
                      { style: { marginTop: 0 } },
                      this.props.dialogExternalMap.isNew ? 'Add External Import Map' : 'Edit External Import Map',
                    ),
                    T(
                      'div',
                      { style: { marginBottom: '20px' } },
                      T('label', { htmlFor: 'external-importmap-url' }, 'URL to import map:'),
                      T(
                        'span',
                        { style: { position: 'relative' } },
                        T('input', {
                    ...
                    T(
                      ...
                      T(
                        'button',
                        { type: 'button', onClick: this.props.cancel, style: { marginRight: '16px' } },
                        'Cancel',
                      ),
                      T(
                        'button',
                        { type: 'submit', className: this.state.url ? 'imo-overridden' : 'imo-default' },
  ...
  function me() {
    return (
      Object.keys(window.importMapOverrides.getOverrideMap().imports).filter(function (e) {
        return !pe[e];
      }).length > 0
    );
  }
    ...
    function l() {
      ...
      return (
        ...
        o(p(e), 'updateModuleUrl', function (t) {
          null === (t = t || null)
            ? window.importMapOverrides.removeOverride(e.state.dialogModule.moduleName)
            : window.importMapOverrides.addOverride(e.state.dialogModule.moduleName, t),
        ...
        o(p(e), 'addNewModule', function (t, n) {
          t && n && window.importMapOverrides.addOverride(t, n), e.setState({ dialogModule: null });
        }),
        o(p(e), 'filterModuleNames', function (t) {
          return !(e.state.searchVal.trim().length > 0) || g(t, e.state.searchVal);
        }),
        e
      );
    }
          ...
          value: function (e, t) {
            !t.dialogModule && this.state.dialogModule
              ...
              : t.dialogModule &&
                ...
                (ie(null, this.dialogContainer), this.dialogContainer.remove(), delete this.dialogContainer),
              !t.dialogExternalMap && this.state.dialogExternalMap
                ? ((this.dialogContainer = document.createElement('div')),
                  document.body.appendChild(this.dialogContainer),
                  ie(
                    T(ue, { dialogExternalMap: this.state.dialogExternalMap, cancel: this.cancel }),
                    this.dialogContainer,
                  ))
                : t.dialogExternalMap &&
          ...
          value: function () {
              ...
              p.disabled
                ...
                ? e.state.currentPageMap.imports[s] === u[s]
                  ? pe[s] && pe[s](e.state.currentPageMap.imports[s]) === u[s]
                    ...
                    : t.push(p)
                  : n.push(p)
                : e.state.notOverriddenMap.imports[s] === e.state.currentPageMap.imports[s]
                ? o.push(p)
                : e.state.notOverriddenMap.imports[s] === e.state.nextPageMap.imports[s]
                ? l.push(p)
                : i.push(p);
            }),
              Object.keys(u)
                ...
                .forEach(function (o) {
                  if (!g(s, o)) {
                    var i = { moduleName: o, defaultUrl: null, overrideUrl: u[o], disabled: g(d, o) };
            ...
            var p = (function () {
                ...
                try {
                  for (l.s(); !(e = l.n()).done; ) {
                    var a = e.value;
                    g(window.importMapOverrides.invalidExternalMaps, a) ? r.push(a) : g(n, a) ? o.push(a) : i.push(a);
                  }
                } catch (e) {
                  l.e(e);
                } finally {
                ...
                return { brokenMaps: r, workingCurrentPageMaps: o, workingNextPageMaps: i };
              })(),
              c = p.brokenMaps,
            ...
            return T(
              ...
              T(
                ...
                T(
                  ...
                  T(
                    ...
                    {
                      onClick: function () {
                        return e.setState({ dialogModule: { moduleName: 'New module', isNew: !0 } });
                      },
                    },
                    'Add new module',
                  ),
                ...
                T(
                  ...
                  T(
                    ...
                    {
                      onClick: function () {
                        e.setState({ dialogExternalMap: { url: '', isNew: !0 } });
                      },
                    },
                    'Add import map',
                  ),
                  ...
                  r.map(function (t) {
                    return T(
                      ...
                      T(
                        'td',
                        null,
                        T('div', { className: 'imo-status imo-disabled-override' }),
                  ...
                  t.map(function (t) {
                    return T(
                      ...
                      T(
                        'td',
                        null,
                        T('div', { className: 'imo-status imo-current-override' }),
                        T('div', null, 'Inline Override'),
                      ),
                      T('td', null, t.moduleName),
                      T('td', null, ge(t)),
                  ...
                  i.map(function (t) {
                    return T(
                      ...
                      T(
                        'td',
                        null,
                        T('div', { className: 'imo-status imo-external-override' }),
                  ...
                  a.map(function (t) {
                    return T(
                      ...
                      T(
                        'td',
                        null,
                        T('div', { className: 'imo-status imo-dev-lib-override' }),
                  ...
                  o.map(function (t) {
                    return T(
                      ...
                      T(
                        'td',
                        null,
                        T('div', { className: 'imo-status imo-default-module' }),
                        T('div', null, 'Default'),
                      ),
                      T('td', null, t.moduleName),
                      T('td', null, ge(t)),
              ...
              (c.length > 0 || m.length > 0 || f.length > 0) &&
                T(
                  'table',
                  { className: 'imo-overrides-table' },
                  T('thead', null, T('th', null, 'Import Map Status'), T('th', null, 'URL')),
                  T(
                    'tbody',
                    null,
                    c.map(function (t) {
                      return T(
                        'tr',
                        {
                          ...
                          tabIndex: 0,
                          onClick: function () {
                            return e.setState({ dialogExternalMap: { isNew: !1, url: t } });
                          },
                          key: t,
                        },
                        T(
  ...
  var he = (document.querySelector('base') && document.querySelector('base').href) || location.origin + '/';
  function ge(e) {
    var t = ye(e),
      n = be(t);
    return n ? n.host : t;
  ...
  var we = (function (e) {
      ...
      function l() {
        ...
        for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++) i[a] = arguments[a];
        return (
          o(p((e = n.call.apply(n, [this].concat(i)))), 'doUpdate', function () {
                ...
                T(
                  ...
                  T(
                    ...
                    T(
                      ...
                      T(
                        'a',
                        { target: '_blank', href: 'https://github.com/joeldenning/import-map-overrides' },
                        'See documentation for more info',
                      ),
                      '.',
                    ),
                  ),
                  T('button', { className: 'imo-unstyled', onClick: e.close }, 'ⓧ'),
                ),
    ...
    xe = (function (e) {
      ...
      function l() {
        ...
        for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++) i[a] = arguments[a];
        return (
          o(p((e = n.call.apply(n, [this].concat(i)))), 'state', { showingPopup: !1 }),
          o(p(e), 'doUpdate', function () {
            return e.forceUpdate();
          }),
          ...
          o(p(e), 'atLeastOneOverride', function () {
            return e.useDevLibs() ? me() : Object.keys(window.importMapOverrides.getOverrideMap().imports).length > 0;
          }),
          e
        );
      }
          ...
          },
          {
            ...
            value: function (e, t) {
              return e.customElement.hasAttribute('show-when-local-storage') &&
                'true' !== localStorage.getItem(e.customElement.getAttribute('show-when-local-storage'))
                ? null
                : T(
                    'div',
                    null,
                    ...
                    t.showingPopup && T(we, { close: this.toggleTrigger, importMapChanged: this.importMapChanged }),
                  );
            },
          },
        ]),
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                this.renderedEl = ie(T(e, { customElement: this }), this, this.renderedEl);
              },
            },
          ],
          [
  ...
  window.customElements &&
    !y &&
    (window.customElements.define('import-map-overrides-full', Me(xe, ['show-when-local-storage'])),
