...
!(function () {
  function e(e, t) {
    return (t || '') + ' (SystemJS Error#' + e + ' https://git.io/JvFET#' + e + ')';
  }
  function t(e, t) {
    if ((-1 !== e.indexOf('\\') && (e = e.replace(/\\/g, '/')), '/' === e[0] && '/' === e[1]))
    ...
    if (
      ...
      for (var i = n.slice(0, n.lastIndexOf('/') + 1) + e, o = [], s = -1, u = 0; i.length > u; u++)
        -1 !== s
  ...
  function r(e, n, r, i, o) {
    for (var c in e) {
      ...
      if ('string' == typeof f) {
        var l = u(i, t(f, r) || f, o);
        l ? (n[a] = l) : s('W1', c, f, 'bare specifier did not resolve');
      }
    }
  }
  function i(e, t) {
  ...
  function o(e, t) {
    ...
    if (n) {
      ...
      s('W2', n, r, "should have a trailing '/'");
    }
  }
  function s(t, n, r, i) {
  ...
  function u(e, t, n) {
    for (var r = e.scopes, s = n && i(n, r); s; ) {
      var u = o(t, r[s]);
      if (u) return u;
      s = i(s.slice(0, s.lastIndexOf('/')), r);
    }
  ...
  function f(e, t, n, r) {
    if ((e.onload(n, t.id, t.d && t.d.map(a), !!r), n)) throw n;
  }
  function l(t, n, r) {
    var i = t[E][n];
    if (i) return i;
    ...
    b && Object.defineProperty(s, b, { value: 'Module' });
    var u = Promise.resolve()
        ...
        .then(
          function (r) {
            ...
            var u = r[1](
              function (e, t) {
                i.h = !0;
                var n = !1;
                if ('string' == typeof e) (e in s && s[e] === t) || ((s[e] = t), (n = !0));
                else {
                  for (var r in e) (t = e[r]), (r in s && s[r] === t) || ((s[r] = t), (n = !0));
          ...
          function (e) {
            throw ((i.e = null), (i.er = e), f(t, i, e, !0), e);
          },
        ),
      c = u.then(function (e) {
        return Promise.all(
    ...
    return (i = t[E][n] =
      { id: n, i: o, n: s, I: u, L: c, h: !1, d: void 0, e: void 0, er: void 0, E: void 0, C: void 0, p: void 0 });
  }
  function d() {
        ...
        if ('systemjs-module' === t.type) {
          ...
          var i = t.src
            ? fetch(t.src, { integrity: t.integrity })
                ...
                .catch(function (n) {
                  return (
                    (n.message = e('W4', 'Error fetching systemjs-import map ' + t.src) + '\n' + n.message),
                    console.warn(n),
                    '{}'
                  );
                })
  ...
  if (!h && 'undefined' != typeof location) {
    var w = (h = location.href.split('#')[0].split('?')[0]).lastIndexOf('/');
    -1 !== w && (h = h.slice(0, w + 1));
  }
  var S,
    b = v && Symbol.toStringTag,
    E = v ? Symbol() : '@',
    O = c.prototype;
                    ...
                    try {
                      ...
                      if (e)
                        return (
                          (e = e.then(
                            function () {
                              (n.C = n.n), (n.E = null), f(t, n, null, !0);
                            },
                            function (e) {
                              throw ((n.er = e), (n.E = null), f(t, n, e, !0), e);
                            },
                          )),
                          (n.E = e)
                        );
                    ...
                    return (
                      n.d.forEach(function (i) {
                        try {
                          ...
                          throw ((n.e = null), (n.er = u), f(t, n, u, !1), u);
                        }
                      }),
  ...
  var j,
    ...
    C = m;
  if (
    ((O.prepareImport = function (e) {
      return (C || e) && (d(), (C = !1)), M;
    }),
    m && (d(), window.addEventListener('DOMContentLoaded', d)),
    m)
  ) {
    window.addEventListener('error', function (e) {
      (I = e.filename), (W = e.error);
    });
    var R = location.origin;
  }
  O.createScript = function (e) {
    var t = document.createElement('script');
    (t.async = !0), e.indexOf(R + '/') && (t.crossOrigin = 'anonymous');
    var n = L.integrity[e];
  ...
  var I,
    ...
    A = O.register;
  (O.register = function (e, t) {
    if (m && 'loading' === document.readyState && 'string' != typeof e) {
      ...
      if (r) {
        ...
        P = setTimeout(function () {
          (T[r.src] = [e, t]), i.import(r.src);
        });
      }
    } else j = void 0;
    return A.call(this, e, t);
  }),
    (O.instantiate = function (t, n) {
      var r = T[t];
      if (r) return delete T[t], r;
      var i = this;
      return new Promise(function (r, o) {
        var s = O.createScript(t);
        s.addEventListener('error', function () {
          o(Error(e(3, 'Error loading ' + t + (n ? ' from ' + n : ''))));
        }),
          s.addEventListener('load', function () {
            if ((document.head.removeChild(s), I === t)) o(W);
            else {
              var e = i.getRegister();
              e && e[0] === j && clearTimeout(P), r(e);
            }
          }),
  ...
  (O.instantiate = function (t, n) {
    ...
    return this.shouldFetch(t)
      ? this.fetch(t, { credentials: 'same-origin', integrity: L.integrity[t] }).then(function (i) {
          if (!i.ok) throw Error(e(7, i.status + ' ' + i.statusText + ', loading ' + t + (n ? ' from ' + n : '')));
          var o = i.headers.get('content-type');
          if (!o || !N.test(o))
            throw Error(e(4, 'Unknown Content-Type "' + o + '", loading ' + t + (n ? ' from ' + n : '')));
  ...
  var _ = O.instantiate;
  (O.instantiate = function (e, t) {
    var n = L.depcache[e];
    if (n) for (var r = 0; n.length > r; r++) l(this, this.resolve(n[r], e), e);
    return _.call(this, e, t);
  }),
    p &&
      'function' == typeof importScripts &&
      (O.instantiate = function (e) {
        var t = this;
    ...
    (function (e) {
      function t(t) {
        return (
          !e.hasOwnProperty(t) ||
          (!isNaN(t) && e.length > t) ||
          (a && e[t] && 'undefined' != typeof window && e[t].parent === window)
        );
      }
      var n,
        r,
        ...
        return s(t, n).then(function (n) {
          ...
          return r.test(s)
            ...
            ? (WebAssembly.compileStreaming
                ? WebAssembly.compileStreaming(n)
                : n.arrayBuffer().then(WebAssembly.compile)
              ).then(function (n) {
  ...
  (O.get = function (e) {
    ...
    (O.set = function (t, n) {
      ...
      k && 'Module' === n[k]
        ? (r = n)
        : ((r = Object.assign(Object.create(null), n)), k && Object.defineProperty(r, k, { value: 'Module' }));
      var i = Promise.resolve(r),
        o = this[E][t] || (this[E][t] = { id: t, i: [], h: !1, d: [], e: null, er: void 0, E: void 0 });
