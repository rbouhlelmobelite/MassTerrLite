  ...
  return (
    ...
    (G.prototype = {
      ...
      abrupt: function (t, r) {
        ...
        return (
          (a.type = t), (a.arg = r), i ? ((this.method = 'next'), (this.next = i.finallyLoc), v) : this.complete(a)
        );
      },
      ...
      delegateYield: function (t, e, n) {
        return (
          (this.delegate = { iterator: N(t), resultName: e, nextLoc: n }), 'next' === this.method && (this.arg = r), v
        );
      },
    }),
    t
