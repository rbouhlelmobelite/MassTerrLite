    ...
    execute: function () {
      ...
      var o = (
        ...
        i = (function () {
          ...
          ? function (t, n) {
              ...
              return (
                n ? e.initCustomEvent(t, n.bubbles, n.cancelable, n.detail) : e.initCustomEvent(t, !1, !1, void 0), e
              );
            }
          : function (t, n) {
              ...
              return (
                (e.type = t),
                n
                  ? ((e.bubbles = Boolean(n.bubbles)), (e.cancelable = Boolean(n.cancelable)), (e.detail = n.detail))
                  : ((e.bubbles = !1), (e.cancelable = !1), (e.detail = void 0)),
                e
              );
            },
        u = [];
      ...
      function f(t, n) {
        ...
        return 'single-spa minified message #'
          .concat(t, ': ')
          .concat(n ? n + ' ' : '', 'See https://single-spa.js.org/error/?code=')
          .concat(t)
      ...
      function B(t, n) {
        return Promise.resolve().then(function () {
          return t.status !== v
            ? t
            : (I || (window.dispatchEvent(new i('single-spa:before-first-mount')), (I = !0)),
              q(t, 'mount')
                .then(function () {
      ...
      function $(t, n) {
        ...
        var p,
          ...
          w = (s = s.then(function (t) {
            ...
            if (Object.prototype.hasOwnProperty.call(t, 'bootstrap') && !D(t.bootstrap)) throw Error(f(9, !1, n));
            ...
            : ((t.status = h),
              (t.loadPromise = Promise.resolve()
                .then(function () {
                  ...
                  return o.then(function (r) {
                    ...
                    (t.loadErrorTime = null),
                      'object' !== e((n = r)) && (o = 34),
                      Object.prototype.hasOwnProperty.call(n, 'bootstrap') && !D(n.bootstrap) && (o = 35),
                      D(n.mount) || (o = 36),
                      D(n.unmount) || (o = 37);
                    var i = S(n);
                    if (o) {
                      ...
                      return console.error(f(o, !1, i, A(t), u), n), a(void 0, t, T), t;
                    }
                    return (
                      n.devtools &&
                        n.devtools.overlays &&
                        (t.devtools.overlays = _({}, t.devtools.overlays, n.devtools.overlays)),
                      (t.status = m),
                ...
                .catch(function (n) {
                  ...
                  return (
                    delete t.loadPromise,
                    r ? (e = T) : ((e = O), (t.loadErrorTime = new Date().getTime())),
                    a(n, t, e),
                    t
                  );
                })));
      ...
      if (Z) {
        ...
        (window.addEventListener = function (t, n) {
          ...
          (window.history.pushState = it(window.history.pushState, 'pushState')),
          (window.history.replaceState = it(window.history.replaceState, 'replaceState')),
          window.singleSpaNavigate ? console.warn(f(41, !1)) : (window.singleSpaNavigate = et);
      }
      function st(t) {
      ...
      function vt(t, n, e, r) {
        (ht[A(t)] = { app: t, resolve: e, reject: r }), Object.defineProperty(ht[A(t)], 'promise', { get: n });
      }
      function wt(t) {
        return ht[t];
      }
      ...
      function Pt(t, n, r, o) {
        var i = (function (t, n, r, o) {
          var i,
            u = { name: null, loadApp: null, activeWhen: null, customProps: null };
          return (
            'object' === e(t)
              ? ((function (t) {
                  ...
                  if (!(o(t.activeWhen) || (Array.isArray(t.activeWhen) && t.activeWhen.every(o))))
                    throw Error(f(24, !1));
        ...
        gt.push(
          _({ loadErrorTime: null, status: p, parcels: {}, devtools: { overlays: { options: {}, selectors: [] } } }, i),
        ),
          Z && (lt(), Rt());
      }
      function bt() {
      ...
      function Nt(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { waitForUnmount: !1 };
      ...
      function Rt() {
        ...
        return Gt() ? ((Dt = !0), (e = u.concat(c, a, s)), w()) : ((e = c), d());
        function m() {
          f = !0;
        }
        function d() {
          ...
          return Promise.resolve().then(function () {
            if (
              (window.dispatchEvent(
                new i(0 === e.length ? 'single-spa:before-no-app-change' : 'single-spa:before-app-change', O(!0)),
              ),
              window.dispatchEvent(new i('single-spa:before-routing-event', O(!0, { cancelNavigation: m }))),
              f)
            )
              return window.dispatchEvent(new i('single-spa:before-mount-routing-event', O(!0))), E(), void et(l);
            var n = u.map(mt),
              r = a
                .map(R)
                .map(function (t) {
